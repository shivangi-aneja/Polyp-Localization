...
class Evaluator:
    ...
    def __call__(self,
        ...
        if return_precisions or return_recalls or return_average_precisions:
            ...
            ret.append(self.tp_count)
            ret.append(self.fp_count)
            ret.append(self.fn_count)
            ret.append(self.polyp_precision)
            ret.append(self.polyp_recall)
            return ret
        else:
    ...
    def match_predictions(self,
        ...
        gt_count = self.data_generator.get_dataset_size()
        ...
        self.fn_count = gt_count - tp_count
        self.polyp_precision = tp_count / (tp_count + fp_count)
        self.polyp_recall = tp_count / gt_count
