...
"""
 File for testing SSD 300 model
"""
...
from localization.ssd_keras.eval_utils.average_precision_evaluator import Evaluator
...
parser.add_argument('-m', '--model_name', type=str, default='ssd300_best',
...
def main():
    ...
    model = ssd_300(image_size=(Config.img_height, Config.img_width, Config.img_channels), n_classes=Config.n_classes,
