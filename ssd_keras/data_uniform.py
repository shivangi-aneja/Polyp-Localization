...
train_img = os.getcwd() + "/data/polyps_hospital/images/"
train_file = os.getcwd() + "/data/polyps_hospital/train.csv"
train_file_new = os.getcwd() + "/data/polyps_hospital/train_new.csv"

val_img = os.getcwd() + "/data/polyps_hospital/images/"
val_file = os.getcwd() + "/data/polyps_hospital/val.csv"

test_img = os.getcwd() + "/data/polyps_hospital/images/"
test_file = os.getcwd() + "/data/polyps_hospital/test.csv"
resized_width = 512
resized_height = 512
        ...
        with open(file_path_read) as f:
            ...
            for row in csv_reader:
                if line_count == 0:
                    ...
                    cv2.imwrite(img_path + file_name, resized_img)
                    new_data.append(
...
resize_data(val_file, os.getcwd() + "/data/polyps_hospital/val_new.csv", val_img)
resize_data(test_file, os.getcwd() + "/data/polyps_hospital/test_new.csv", val_img)
